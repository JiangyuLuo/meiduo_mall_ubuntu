var vm = new Vue({
  ...
  watch: {
    'form_address.province_id': function () {
      if (this.form_address.province_id) {
        axios
          .get(this.host + '/areas/' + this.form_address.province_id + '/', {
            responseType: 'json',
    ...
    'form_address.city_id': function () {
      if (this.form_address.city_id) {
        axios
          .get(this.host + '/areas/' + this.form_address.city_id + '/', {
            responseType: 'json',
            withCredentials: true,
          })
          .then((response) => {
  ...
  methods: {
    ...
    del_address: function (index) {
      axios
        .delete(this.host + '/addresses/' + this.addresses[index].id + '/', {
          withCredentials: true,
          responseType: 'json',
        })
        .then((response) => {
